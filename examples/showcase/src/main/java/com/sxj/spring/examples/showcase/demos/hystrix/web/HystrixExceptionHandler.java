...
public class HystrixExceptionHandler extends ResponseEntityExceptionHandler
{
    ...
    public final ResponseEntity<?> handleException(HystrixRuntimeException e,
            WebRequest request)
    {
        ...
        if (type.equals(FailureType.COMMAND_EXCEPTION))
        {
            ...
            message = com.sxj.spring.modules.utils.Exceptions.getErrorMessageWithNestedException(e);
        }
    ...
    public final ResponseEntity<?> handleException(
            HystrixBadRequestException e, WebRequest request)
    {
