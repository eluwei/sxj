...
import com.sxj.spring.examples.showcase.data.UserData;
...
public class AccountWebServiceWithPredefineClientFT extends
        BaseFunctionalTestCase
{
    ...
    {
        SearchUserResult response = accountWebServiceClient.searchUser(null,
                null);
