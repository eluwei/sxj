...
import com.sxj.spring.examples.showcase.demos.jms.advanced.AdvancedNotifyMessageListener;
import com.sxj.spring.examples.showcase.demos.jms.advanced.AdvancedNotifyMessageProducer;
...
@ContextConfiguration(locations = { "/applicationContext.xml",
        "/jms/applicationContext-jms-advanced.xml" })
public class JmsAdvancedTest extends SpringContextTestCase
{
    ...
    public void queueMessage()
    {
        ...
        Threads.sleep(1000);
        assertThat(appender.getFirstMessage()).isEqualTo("UserName:calvin, Email:calvin@sringside.org.cn, ObjectType:user");
    }
