 ...
 *******************************************************************************/
package com.sxj.spring.examples.showcase.demos.mail;
...
import com.sxj.spring.examples.showcase.demos.utilities.email.MimeMailService;
...
public class MailServiceTest extends SpringContextTestCase
{
    ...
    private String getMainPartText(Part mainPart) throws MessagingException,
            IOException
    {
        return (String) ((Multipart) mainPart.getContent()).getBodyPart(0)
                .getContent();
    }
}
